...
- AI-турагент «Алиса» с сохранением контекста диалога (вылет, состав туристов, бюджет), естественными переходами без повторных приветствий, экспертными советами по локациям и сезонам;
...
<head>
  ...
  <link rel="stylesheet" href="styles.css?v=ui-clean-v6">
...
<body>
  ...
  <script src="app.js?v=tour-proposals-v6"></script>
</body>
</html>
